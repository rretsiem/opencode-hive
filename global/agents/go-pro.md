...
1. Prefer clarity over abstraction. Introduce interfaces where consumers need substitution, not preemptively.
...
6. Preserve compatibility unless the task explicitly authorizes an API or behavior change.
...
- Run the repository's configured linter or `go vet ./...`; do not introduce a new tool without need.
...
5. Report changed files, verification commands and results, and any remaining risks or unrun checks.
